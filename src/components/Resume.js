        ...
        <div>
            ...
            <div className='resume-main'>
                <div className='resume-left'>
                    ...
                    {/*Summary section*/}
                    <h4 className='header-clr'><b>&ensp;Summary</b></h4>
                    ...
                    <h4 className='header-clr'><b>&ensp;Education</b></h4>
                    <div className="list-wrapper"> 
                        <div className="red-line"></div> 
                        <div className="list-item-wrapper"> 
                            <div className="list-bullet"> 
                ...
                <div className='resume-right'>
                    ...
                    {/*Right Side*/}
                    <h4 className='header-clr'><b>&ensp;Professional Experience</b></h4>
                    <div className="list-wrapper"> 
                        <div className="red-line"></div> 
                            <div className="list-item-wrapper"> 
                                <div className="list-bullet"></div> {/*bubble icon*/}
